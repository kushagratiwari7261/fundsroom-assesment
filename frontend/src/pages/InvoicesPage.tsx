            ...
            <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[1,2,3,4,5,6].map(i => (
                <div key={i} style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                  <div className="skel" style={{ width: '18%', height: '18px' }}></div>
                  <div className="skel" style={{ width: '20%', height: '18px' }}></div>
                  <div className="skel" style={{ width: '8%', height: '18px' }}></div>
                  <div className="skel" style={{ width: '15%', height: '18px' }}></div>
                  <div className="skel" style={{ width: '12%', height: '18px', marginLeft: 'auto' }}></div>
                </div>
              ))}
            </div>
          </>
